...
object HttpModuleSolution {
  ...
  private fun okClient(): OkHttpClient {
    return OkHttpClient.Builder()
      ...
      .addInterceptor(AddHeaderInterceptor("User-Agent", "Http Codelab"))
      .connectTimeout(10, TimeUnit.SECONDS)
      .readTimeout(3, TimeUnit.SECONDS)
      .cache(Cache(File("httpCodelabCache"), 1024 * 1024 * 2))
      .authenticator(BearerAuthenticator("1234567890abcdefhijklmnopqrstuvwxyz"))
      .addInterceptor(DripReadTimeoutInterceptor())
      .certificatePinner(httpBinCertificatePinner())
      .addNetworkInterceptor(BlockGitHubHostInterceptor()) // works only for tests with mocked network
      .build()
  }
